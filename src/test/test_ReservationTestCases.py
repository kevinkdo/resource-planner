...
class ReservationTestCases(unittest.TestCase):
  ...
  def test_CreateValidReservationWithValidUserID(self):
      reservation = {"user_id": "1", "resource_id": "1", "begin_time": "2011-08-06T10:54:17Z", "end_time": "2011-08-06T11:00:00Z", "should_email": "true"}
      r = requests.post(self.baseUrl + self.reserveUrl, data = json.dumps(reservation), headers = self.headers)
      decoded = r.json()
      assert decoded['is_error'] == False
      assert decoded['data'] == {u'should_email': True, u'user_id': 1, u'resource_id': 1, u'end_time': u'2011-08-06T11:00:00Z', u'begin_time': u'2011-08-06T10:54:17Z', u'reservation_id': 1}
      assert decoded['error_msg'] == 'Reservation inserted successfully'

  def test_CreateValidReservationWithInvalidUserID(self):
      reservation = {"user_id": "2", "resource_id": "1", "begin_time": "2011-08-06T10:54:17Z", "end_time": "2011-08-06T11:00:00Z", "should_email": "true"}
      r = requests.post(self.baseUrl + self.reserveUrl, data = json.dumps(reservation), headers = self.headers)
      decoded = r.json()
  ...
  def test_CreateInvalidReservationWithInvalidResourceID(self):
      reservation = {"user_id": "1", "resource_id": "3", "begin_time": "2011-08-06T10:54:17Z", "end_time": "2011-08-06T11:00:00Z", "should_email": "true"}
      r = requests.post(self.baseUrl + self.reserveUrl, data = json.dumps(reservation), headers = self.headers)
      decoded = r.json()
      assert decoded['is_error'] == True
      assert decoded['data'] == None
  ...
  def test_CreateInvalidReservationInvalidTimeRange(self):
      reservation = {"user_id": "1", "resource_id": "1", "begin_time": "2012-08-06T10:54:17Z", "end_time": "2011-08-06T11:00:00Z", "should_email": "true"}
      r = requests.post(self.baseUrl + self.reserveUrl, data = json.dumps(reservation), headers = self.headers)
      decoded = r.json()
      assert decoded['is_error'] == True
      assert decoded['data'] == None
  ...
  def test_GetReservationWithValidID(self):
      ...
      decoded = r.json()
      assert decoded['is_error'] == False
      assert decoded['data'] == {u'should_email': True, u'resource': {u'description': u'some resource description', u'tags': [], u'name': u'some resource', u'resource_id': 1}, u'end_time': u'2011-08-06T11:00:00Z', u'begin_time': u'2011-08-06T10:54:17Z', u'reservation_id': 1, u'user': {u'user_id': 1, u'username': u'admin', u'should_email': False, u'email': u'admin@admin.com'}}
  ...
  def test_PutReservationWithValidIDUpdateAllFields(self):
      ...
      decoded = r.json()
      assert decoded['is_error'] == False
      assert decoded['data'] == {u'should_email': False, u'user_id': 1, u'resource_id': 2, u'end_time': u'2011-08-06T11:00:00Z', u'begin_time': u'2011-08-06T10:54:17Z', u'reservation_id': 1}

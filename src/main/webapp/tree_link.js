const TreeLink = React.createClass({
  ...
  render() {
    var line = <line className="link" stroke={this.setStroke()} x1={this.props.source.x+8} y1={this.props.source.y+16} x2={this.props.target.x+8} y2={this.props.target.y} onClick={() => this.props.setSelectedLink({source_id: this.props.source.resource_id, target_id: this.props.target.resource_id})}></line>;

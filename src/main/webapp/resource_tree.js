const ResourceTree = React.createClass({ 
  ...
  render() {
    ...
    var helpText = <text className="helpText" x={0} y={0}>Click on a node or link to select it. Drag a node to another node to make a new link. Purple ellipses are resources you can't see but are in the hierarchy. Restricted resources are shown in red.</text>;

...
\subsubsection{Current Design}
For evolution 2, we simply expanded our suite of tests to include groups, permissions, and the new login protocol with net-ids. These can be found in the classes test\_AuthorizationTestCases.py, test\_GroupsTestCases.py, and test\_PermissionsTestCases.py. See (\hyperref[appendix:backendtest]{Appendix \ref{appendix:backendtest}}) for the full suite of tests. 

...
\subsubsection{Evolution 4}

Kevin Do 

Davis Treybig 

Jiawei Zhang implemented the resource hierarchy. 

Michael Han 

\subsubsection{Full Project}

Kevin Do

Davis Treybig

Jiawei Zhang set up back-end infrastructure (Java Spring, Postgres) and implemented users, initial resources, groups, resource hierarchy, OAuth2 authentication. Also refactored reservations. 

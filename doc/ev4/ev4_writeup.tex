...
In evolution 1, Davis worked primarily on setting up reservations in the backend. In evolution 2, Davis worked on setting up the backend permissions system, including all of the permission REST endpoints as well as internal permission methods used across all other classes. He also added email. In evolution 3, Davis expanded the email system, as well as worked on the incomplete reservations endpoints and systems. Finally, in evolution 4, Davis implemented the shared resources feature. 
